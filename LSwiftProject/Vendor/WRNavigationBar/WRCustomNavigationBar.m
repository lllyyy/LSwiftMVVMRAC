...
- (void)wr_setRightButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted title:(NSString *)title titleColor:(UIColor *)titleColor
{
    ...
    [self.rightButton setTitleColor:UIColorHex(0xe3e3e3) forState:UIControlStateDisabled];
    [self.rightButton setTitleColor:titleColor forState:UIControlStateHighlighted];
}
...
-(UILabel *)titleLable {
    if (!_titleLable) {
        ...
        _titleLable.font = [UIFont boldSystemFontOfSize:kWRDefaultTitleSize];
